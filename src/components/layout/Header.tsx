...
const Header = () => {
  ...
  return (
    <header className="sticky top-0 z-10 h-14 md:h-16 border-b border-border bg-card/95 backdrop-blur-sm flex items-center justify-between px-3 md:px-6 shadow-sm">
      ...
      <div className="flex items-center gap-2 md:gap-4">
        <div className="hidden sm:flex items-center gap-2 md:gap-3 px-3 md:px-4 py-2 rounded-lg bg-muted shadow-sm border border-border">
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button 
              variant="ghost" 
              className="relative h-10 w-10 md:h-12 md:w-12 rounded-full ring-2 ring-primary/40 hover:ring-primary/60 transition-all duration-200 shadow-md hover:shadow-lg"
            >
              <Avatar className="h-10 w-10 md:h-12 md:w-12 ring-2 ring-background">
                <AvatarFallback className="bg-gradient-primary text-white text-sm md:text-base font-bold shadow-elegant">
